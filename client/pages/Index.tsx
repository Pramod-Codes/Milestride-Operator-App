...
function HomeView({ setView }: { setView: (v: View) => void }) {
  return <>
    <main className="page home-page">
      ...
      <section className="health-card"><div><p className="eyebrow">FLEET HEALTH</p><h3>85% <span>Healthy vehicles</span></h3><p className="positive">↑ 6% <em>vs yesterday</em></p></div><div className="health-ring"><div><b>124</b><span>vehicles</span></div></div></section>
